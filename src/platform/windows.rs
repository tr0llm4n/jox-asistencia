...
{sleep}
    ",
        ...
        // Marca Jox: el binario del crate es 'rustdesk.exe' pero APP_NAME=JoxAsistencia,
        // así que tras copiar hay que renombrarlo al nombre que espera el servicio
        // (install_me no lo hacía; con RustDesk oficial no hacía falta porque coincidían).
