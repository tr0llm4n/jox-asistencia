    ...
    if args.is_empty() || crate::common::is_empty_uni_link(&args[0]) {
        ...
        #[cfg(windows)]
        {
            ...
            if args[0] == "--uninstall" {
                ...
                // Marca Jox: SIN icono de escritorio en instalación desatendida
                // (el agente instala esto en equipos cliente; no debe ensuciar el
                // escritorio del usuario final con un acceso directo).
                #[cfg(not(windows))]
                let options = "startmenu";
                #[cfg(windows)]
                let options = "startmenu printer";
