...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("JoxAsistencia".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remoto.joxsystem.com"];
pub const RS_PUB_KEY: &str = "H3yeusa0FeVrxLs4MIV62EFzT+TqRQu0fI5gmDmSWWw=";
